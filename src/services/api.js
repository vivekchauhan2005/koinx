// ─── Mock Holdings Data ────────────────────────────────────────────────────
// Each holding has its own STCG/LTCG breakdown.
// These represent unrealized gains/losses on individual coins.
const mockHoldings = [
  {
    id: 1,
    coin: "Bitcoin",
...
// This is the portfolio-level summary BEFORE any tax-loss harvesting.
// Think of it as: gains already realised this financial year from all trades.
...
// ─── API Functions (Promise + setTimeout) ─────────────────────────────────

export const fetchHoldings = () => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      // Uncomment below to test the error state:
